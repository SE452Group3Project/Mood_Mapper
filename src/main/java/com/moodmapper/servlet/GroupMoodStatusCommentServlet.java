 ...
 * @author Owner
 */
@WebServlet(name = "GroupMoodStatusCommentServlet", urlPatterns = {"/GroupMoodStatusCommentServlet"})
public class GroupMoodStatusCommentServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String groupName = (String)session.getAttribute("currentgroup");
        // forward request and response to jsp page
        String url = "/group_mood_statuses.jsp?groupname=" + groupName;
        RequestDispatcher dispatcher = getServletContext().getRequestDispatcher(url);
        dispatcher.forward(request, response);
        
        //response.sendRedirect("/group_mood_maps.jsp?groupname=" + groupName);
    }
